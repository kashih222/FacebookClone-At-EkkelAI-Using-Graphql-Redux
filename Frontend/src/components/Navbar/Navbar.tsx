        ...
        `}
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-3 flex-1 justify-end">
            {me ? (
              ...
              <Link to="/login">
                <button className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold cursor-pointer transition">
                  <span>Log In</span>
                </button>
              </Link>
            )}
            ...
            {me ? (
              ...
              <div className="px-4 py-6 border-b border-gray-200 flex justify-center">
                <Link to="/login" onClick={toggleMobileMenu}>
                  <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold text-base w-full">
                    Log In
                  </button>
                </Link>
              </div>
